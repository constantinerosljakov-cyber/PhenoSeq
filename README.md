...
git clone https://github.com/your-username/PhenoSeq.git
cd PhenoSeq
...
jupyter notebook PhenoSeq_v3_integrated.ipynb
...
```
PhenoSeq/
├── PhenoSeq_v3_integrated.ipynb   # main notebook — full pipeline
├── hpo_metrics.py                 # evaluation metrics module
├── requirements.txt               # pinned dependencies
├── PhenoSeq_Report_updated.tex    # academic paper (LaTeX)
...
@misc{rosljakov2026phenoseq,
  ...
  year    = {2026},
  url     = {https://github.com/your-username/PhenoSeq}
}
```
